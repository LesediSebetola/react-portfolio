    ...
    <div className='border-b border-neutral-900 pb-4'>
        ...
        <div>
            {EXPERIENCES.map((experience, index) =>(
              <div key={index} className='mb-8 flex fle-wrap lg:justify-center'>
        ...
        <div>
              ...
              <div className='mb-8 flex fle-wrap lg:justify-center'>
                <div className='w-full lg:w-1/4'>
                ...
                <div className='w-full max-w-xl lg:w-3/4'>
                  ...
                  Freelance Frontend Developer
                    <span className='text-sm text-purple-100'>Growit MC</span>
                  </h6>
                  <p className='mb-4 text-neutral-400'>An application for managing tasks and projects, with features such as task creation, assignment, and progress tracking.</p>
